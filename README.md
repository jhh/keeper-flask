...
## Development environment and release process
 ...
 - create virtualenv with Flask and Trapper Keeper installed into it (latter is installed in
...
install it (`pip install keeper.tar.gz`), ensure that configuration file exists and
`KEEPER_SETTINGS` environment variable points to it, ensure that user has access to the
